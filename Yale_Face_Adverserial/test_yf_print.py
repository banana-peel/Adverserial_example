...
print("Testing matrix shape", X_test)
...
per_out = tf.expand_dims(tf.reshape(tf.cast(sign[0,0,:],tf.uint8),[150,150]),2)
orig_out = tf.expand_dims(tf.reshape(tf.cast(xp_test*255,tf.uint8),[150,150]),2)
adv_out = tf.expand_dims(tf.reshape(tf.cast(test_image*255,tf.uint8),[150,150]),2)
